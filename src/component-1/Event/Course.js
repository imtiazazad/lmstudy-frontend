...
const Course = ({ course }) => {
    return (
        <div className='group hover:transition overflow-hidden'>
            <div>
            ...
            <div className=' flex justify-center items-center gap-5 p-5 border-b-8 border-[#0067DA]   group-hover:duration-1000 group-hover:ease-in-out group-hover:bg-[#0067DA] mt-2 h-[150px] '>
                ...
                <div className='text-[#192f59] border-l-2 border-[#0067DA] group-hover:border-white pl-4 group-hover:text-white'>
